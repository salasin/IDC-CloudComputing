...
def execute_enqueue():
    ...
    redis_conn.rpush(WORK_QUEUE, json.dumps({'work_id': work_id, 'iterations': iterations}))
...
if __name__ == '__main__':
    ...
    if is_primary:
        ...
        scheduler.add_job(func=report_work_queue_len, args=[redis_server_ip], trigger="interval", seconds=10)
        scheduler.start()
